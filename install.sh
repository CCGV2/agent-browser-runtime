...
for file in Dockerfile package.json package-lock.json compose.yaml browser-broker.cjs browser-client.cjs session-pool.cjs docker-focus.cjs desktop-config.cjs; do
